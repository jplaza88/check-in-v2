...
export default function ThemeToggle() {
  ...
  return (
      <div>
          ...
          />
          <label
              className="flex h-8 w-8 cursor-pointer items-center justify-center rounded-full hover:bg-gray-200/50 lg:hover:bg-gray-200/50 dark:hover:bg-gray-700/50 dark:lg:hover:bg-gray-700/50"
