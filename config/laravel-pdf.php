...
return [
    ...
    'browsershot' => [
        ...
        /*
         * Defaulted to true, unlike the package default. Every environment here
         * renders inside a container as an unprivileged user (sail locally,
         * www-data in the production image), where Chrome's sandbox needs user
         * namespaces that are not available. Without this, rendering fails with
         * "No usable sandbox!".
         */
