...
it('calculates zero distance for identical coordinates', function (): void {
    ...
    expect($service->calculateDistance(40.7128, -74.006, 40.7128, -74.006))->toBe(0.0);
});

it('calculates distance between two known points in miles', function (): void {
    $service = new CheckInAvailabilityService(new LocationScheduleService);

    $distance = $service->calculateDistance(40.7128, -74.006, 34.0522, -118.2437);
...
it('respects decimal places parameter', function (): void {
    ...
    $twoDecimals = $service->calculateDistance(40.7128, -74.006, 40.7580, -73.9855, 2);
    $zeroDecimals = $service->calculateDistance(40.7128, -74.006, 40.7580, -73.9855, 0);
...
it('returns symmetric distance regardless of direction', function (): void {
    ...
    $forward = $service->calculateDistance(40.7128, -74.006, 26.142, -80.478);
    $reverse = $service->calculateDistance(26.142, -80.478, 40.7128, -74.006);
