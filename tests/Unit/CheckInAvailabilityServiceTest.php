...
it('calculates zero distance for identical coordinates', function () {
...
it('calculates distance between two known points in miles', function () {
    $service = new CheckInAvailabilityService(new LocationScheduleService);
...
it('returns symmetric distance regardless of direction', function () {
    $service = new CheckInAvailabilityService(new LocationScheduleService);
