...
it('renders the check-in location select page with check-in-enabled locations', function () {
...
it('renders the appointment location select page with appointment-enabled locations', function () {
